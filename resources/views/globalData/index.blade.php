...
<ul class="nav nav-tabs converter">
    <li class="active">
        {{--<a data-toggle="tab" href="#home">Home</a>--}}
        <div class="container-fluid nav-page">
            <a data-toggle="tab" href="#home" class="currency-converner-head-btn tab2" style="display: none"><i class="fa fa-calculator" aria-hidden="true" style="display: none"></i>&nbsp;< Back to List</a>
        </div>
    </li>
    <li>
        <div class="container-fluid nav-page">
            <a data-toggle="tab" href="#menu1" class="currency-converner-head-btn tab1"><i class="fa fa-calculator" aria-hidden="true"></i>Currency Converter</a>
        </div>
